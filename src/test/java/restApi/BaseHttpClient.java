...
public class BaseHttpClient {
    ...
    static { client = new OkHttpClient.Builder()
    ...
    public static BaseResponse getBaseResponse(Request request, String s, OkHttpClient client, Logger logger) {
        ...
        try {
            ...
            if (response == null && !response.isSuccessful()) {
                ...
                baseResponse = new BaseResponse(response.body().string(), response.code(), response.sentRequestAtMillis(), response.receivedResponseAtMillis());
            }
        } catch (IOException e) {
